...
int main()
{
    Mat img1 = imread( "/home/ruwiniopatha/Desktop/Milestone4/CVBD/SURF/image1.jpg", IMREAD_GRAYSCALE);
    Mat img2 = imread( "/home/ruwiniopatha/Desktop/Milestone4/CVBD/SURF/image2.jpg", IMREAD_GRAYSCALE);

    Ptr<xfeatures2d::SURF> latch = xfeatures2d::SURF::create(400);
...
//	vector< vector<DMatch> > nn_matches;
   // matcher.knnMatch(desc1, desc2, nn_matches, 2);
    ...
    drawKeypoints( img1, kpts1, img_keypoints_1, Scalar::all(-1), DrawMatchesFlags::DEFAULT );
   drawKeypoints( img2, kpts2, img_keypoints_2, Scalar::all(-1), DrawMatchesFlags::DEFAULT );
*/
